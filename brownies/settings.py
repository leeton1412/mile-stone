"""
Django settings for brownies project.
...
WSGI_APPLICATION = 'brownies.wsgi.application'
...
if 'USE_AWS' in os.environ:
    # AWS settings
    AWS_STORAGE_BUCKET_NAME = 'cakestation'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'cakestation@example.com'
else:
